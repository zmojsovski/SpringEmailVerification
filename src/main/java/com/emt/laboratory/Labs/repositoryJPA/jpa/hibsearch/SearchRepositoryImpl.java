package com.emt.laboratory.Labs.repositoryJPA.jpa.hibsearch;

import com.emt.laboratory.Labs.repositoryJPA.jpa.SearchRepository;
...
public class SearchRepositoryImpl implements SearchRepository {
    ...
    @Override
    public <T> List<T> searchPhrase(Class<T> entityClass,
                                    String text,
                                    String... fields) {
        // get the full text entity manager
        FullTextEntityManager fullTextEntityManager =
    ...
    public PhraseMatchingContext getMultipleFiledQuery(QueryBuilder qb, String... fields) {
        PhraseMatchingContext phraseQuery = qb.phrase()
                .onField(fields[0]);
